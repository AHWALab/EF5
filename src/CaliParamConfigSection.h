...
class CaliParamConfigSection : public ConfigSection {
 public:
  ...
  float ARSGetCritObjScore() {
    return ars_critObjScore;
  }
  float ARSGetConvCriteria() {
    return ars_convergenceCriteria;
  }
  int ARSGetBurnInSets() {
    return ars_burnInSets;
  }
