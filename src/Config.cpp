    ...
    for (int i = 0; i < MODEL_QTY; i++) {
      if (strcasecmp(sectionName, modelParamSetStrings[i]) == 0) {
        ...
        g_caliParamConfigs[i].insert(
            std::pair<std::string, CaliParamConfigSection*>(sectionVal, cpSec));
        newSec = cpSec;
        break;
      }
    }
    ...
    for (int i = 0; i < ROUTE_QTY; i++) {
      if (strcasecmp(sectionName, routeParamSetStrings[i]) == 0) {
        ...
        g_routingParamSetConfigs[i].insert(
            std::pair<std::string, RoutingParamSetConfigSection*>(sectionVal, psSec));
        newSec = psSec;
        break;
        ...
        g_routingCaliParamConfigs[i].insert(
            std::pair<std::string, RoutingCaliParamConfigSection*>(sectionVal, cpSec));
        newSec = cpSec;
        break;
      }
    }
    ...
    for (int i = 0; i < SNOW_QTY; i++) {
      if (strcasecmp(sectionName, snowParamSetStrings[i]) == 0) {
        ...
        g_snowParamSetConfigs[i].insert(
            std::pair<std::string, SnowParamSetConfigSection*>(sectionVal, psSec));
        newSec = psSec;
        break;
        ...
        g_snowCaliParamConfigs[i].insert(
            std::pair<std::string, SnowCaliParamConfigSection*>(sectionVal, cpSec));
        newSec = cpSec;
        break;
      }
    }
    ...
    for (int i = 0; i < INUNDATION_QTY; i++) {
      if (strcasecmp(sectionName, inundationParamSetStrings[i]) == 0) {
        ...
        g_inundationParamSetConfigs[i].insert(
            std::pair<std::string, InundationParamSetConfigSection*>(sectionVal, psSec));
        newSec = psSec;
        break;
        ...
        g_inundationCaliParamConfigs[i].insert(
            std::pair<std::string, InundationCaliParamConfigSection*>(sectionVal, cpSec));
        newSec = cpSec;
        break;
      }
    }
