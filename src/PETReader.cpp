...
bool PETReader::Read(char* file, SUPPORTED_PET_TYPES type, std::vector<GridNode>* nodes,
                     std::vector<float>* currentPET, float petConvert, bool isTemp, float jday,
                     std::vector<float>* prevPET) {
