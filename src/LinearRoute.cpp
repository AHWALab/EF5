...
void LRRoute::InitializeStates(TimeVar* beginTime, char* statePath, std::vector<float>* fastFlow,
                               std::vector<float>* slowFlow) {}
void LRRoute::SaveStates(TimeVar* currentTime, char* statePath, GridWriterFull* gridWriter) {}

bool LRRoute::Route(float stepHours, std::vector<float>* fastFlow, std::vector<float>* slowFlow,
